...
class MySexyVariables:
    ...
    SEARCH_DIRECTORY = Path.home() / "cyon"
    ...
    sd_download_dir = Path("/sdcard/Download")
    ...
    sd_download_list = os.listdir(sd_download_dir)
            ...
            while True:
                ...
                if command == MySexyVariables.calls_list[0]:  # download
                    ...
                    while True:
                        ...
                        elif command == MySexyVariables.dir_list[6]:
                            list_dirs.sd_download_list()
                        elif command == MySexyVariables.dir_list[7]:
                            Main_Termux.main()
                        else:
                            continue
